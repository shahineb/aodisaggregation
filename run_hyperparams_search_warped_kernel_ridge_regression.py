"""
Description : Runs hyperparameter search for warped aggregate kernel ridge regression experiment

Usage: run_hyperparams_search_warped_kernel_ridge_regression.py  [options] --cfg=<path_to_config> --o=<output_dir>
...
from run_warped_kernel_ridge_regression import migrate_to_device, fit, predict
...
def make_model(cfg, data, hyperparams):
    ...
    kernel.lengthscale = hyperparams['lengthscale'] * torch.ones(ard_num_dims)
