...
Usage: run_svgp_additive_kernel.py  [options] --cfg=<path_to_config> --o=<output_dir>
...
def make_model(cfg, data):
    ...
    latlon_kernel = kernels.ScaleKernel(HaversineMaternKernel(nu=1.5, active_dims=[2, 3], lengthscale_constraint=constraints.LessThan(math.pi / 2)))
    ...
    omega_kernel = kernels.ScaleKernel(kernels.MaternKernel(nu=0.5, ard_num_dims=1, active_dims=[7]))
