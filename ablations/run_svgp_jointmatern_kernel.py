...
Usage: run_svgp_jointmatern_kernel.py  [options] --cfg=<path_to_config> --o=<output_dir>
...
def make_model(cfg, data):
    ...
    # Define GP kernel
    kernel = kernels.MaternKernel(nu=1.5, ard_num_dims=7, active_dims=[0, 2, 3, 4, 5, 6, 7])
