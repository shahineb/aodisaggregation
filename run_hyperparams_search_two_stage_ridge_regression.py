"""
Description : Runs hyperparameter search for two-stage ridge regression experiment

Usage: run_hyperparams_search_two_stage_ridge_regression.py  [options] --cfg=<path_to_config> --o=<output_dir>
...
from run_two_stage_ridge_regression import migrate_to_device, fit, predict
...
def make_model(cfg, data, hyperparams):
    ...
    # Instantiate model
    model = TwoStageAggregateRidgeRegression(lbda_2d=hyperparams['lbda_2d'],
