...
from .gamma_regression import AggregateGammaRegression, AggregateBernoulliGammaRegression, AggregateMAPGPGammaRegression
...
__all__ = ['AggregateRidgeRegression', 'TwoStageAggregateRidgeRegression', 'WarpedAggregateRidgeRegression', 'WarpedTwoStageAggregateRidgeRegression',
           'AggregateGammaRegression', 'AggregateBernoulliGammaRegression', 'AggregateMAPGPGammaRegression',
