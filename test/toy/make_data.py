...
from src.preprocessing.preprocess_model_data import load_dataset, standardize
from src.preprocessing.tensors import make_3d_covariates_tensors, make_2d_covariates_tensors, make_3d_tensor, make_2d_tensor
...
field_names = ['dataset',
               ...
               'h',
               'h_std']
ToyData = namedtuple(typename='ToyData', field_names=field_names, defaults=(None,) * len(field_names))


def make_toy_data(cfg, include_2d=False):
