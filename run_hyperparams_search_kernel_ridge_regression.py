"""
Description : Runs hyperparameter search for aggregate kernel ridge regression experiment

Usage: run_hyperparams_search_kernel_ridge_regression.py  [options] --cfg=<path_to_config> --o=<output_dir>
...
from run_kernel_ridge_regression import migrate_to_device, fit, predict
